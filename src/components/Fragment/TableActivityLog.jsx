...
const TableActivityLog = ({handleSort, handleDelete, filteredActivities}) => {
  return (
      <Table style="w-full text-left border-collapse">
        <thead>
          <tr>
            <th
              className="border-b p-2 cursor-pointer text-sm md:text-md"
            ...
            <th className="border-b p-2 text-sm md:text-md">Review</th>
            <th className="border-b p-2 text-sm md:text-md">Delete</th>
          </tr>
        </thead>
        <tbody>
          {filteredActivities.length > 0 ? (
            filteredActivities.map((activity, index) => (
              <tr key={index} className="border-b">
                <td className="p-2 md:p-4 text-sm md:text-md">
